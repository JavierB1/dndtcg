...
// URL de tu función de Netlify (¡IMPORTANTE! Debe ser la URL exacta de tu función desplegada)
const NETLIFY_FUNCTION_URL = 'https://luminous-frangipane-754b8d.netlify.app/.netlify/functions/manage-sheetdb';

// Contraseña de administrador para la función (¡Debe coincidir con la variable de entorno ADMIN_PASSWORD en Netlify!)
const ADMIN_FUNCTION_PASSWORD = 'TU_CONTRASEÑA_SEGURA_PARA_EL_ADMIN'; // <-- ¡IMPORTANTE! Reemplaza con tu contraseña real
    ...
    try {
        const response = await fetch(NETLIFY_FUNCTION_URL, {
            ...
            headers: {
                ...
                'X-Admin-Password': ADMIN_FUNCTION_PASSWORD // Enviar la contraseña en una cabecera personalizada
            },
